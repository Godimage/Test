...
<div class="<?php echo esc_attr( $gallery_item_class ); ?> yith_featured_content <?php echo esc_attr( $browser ); ?>"
	data-thumb="<?php echo esc_attr( $thumbnail_url ); ?>">
	<div class="ywcfav-video-content <?php echo esc_attr( $video_class ); ?>" style="<?php echo esc_attr( $custom_css ); ?>">
		<?php
		require 'template_video_' . $video_class . '_player.php';
		?>
	</div>
</div>
