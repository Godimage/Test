...
if ( ! empty( $all_audio ) ) :?>
	...
	<div class="ywcfav_thumbnails_audio_container">
		<div class="ywcfav_slider_info">
			<div class="ywcfav_slider_name"><?php esc_html_e( 'Featured Audios', 'yith-woocommerce-featured-video' ); ?></div>
		...
		<div class="ywcfav_slider_wrapper">
			<div class="ywcfav_slider">
				<div class="ywcfav_slider_audio owl-carousel owl-theme" data-n_columns="<?php echo esc_attr( $columns ); ?>">
					<?php
					...
					foreach ( $all_audio as $audio ) {
						...
						?>
						<div id="<?php echo esc_attr( $audio['id'] ); ?>" class=" ywcfav_video_modal_container">
