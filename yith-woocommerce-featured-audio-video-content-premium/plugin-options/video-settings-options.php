	...
	'video-settings' => array(
		...
		'aspectratio'        => array(
			...
			'options'   => array(
				'16_9'   => '16:9',
				'4_3'    => '4:3',
				'custom' => __( 'Custom Aspect Ratio', 'yith-woocommerce-featured-video' ),
			),
		...
		'youtube_theme'                => array(
			...
			'desc'      => __( 'Set the Youtube player style', 'yith-woocommerce-featured-video' ),
			/** For translation team, string added since 1.3.0  */
		),
		'youtube_color'                => array(
		...
		'vimeo_show_title'             => array(
			...
			'desc'      => __( 'Choose whether to show the video title in the Vimeo player or not', 'yith-woocommerce-featured-video' ),
			/** For translation team, string added since 1.3.0  */
		),
		'vimeo_color'                  => array(
			'name'      => __( 'Color', 'yith-woocommerce-featured-video' ),
			...
			'desc'      => __( 'Set the playback controls color for the Vimeo player', 'yith-woocommerce-featured-video' ),
			/** For translation team, string added since 1.3.0  */
		...
		'player_type_style' => array(
			...
			'desc'      => __( 'Set the default style or customize with different colors', 'yith-woocommerce-featured-video' ),
			/** For translation team, string added since 1.3.0  */
		),
		...
		'slider_color_settings' => array(
			...
			'desc'         => __( 'Set the color for progress and volume bars and for the background', 'yith-woocommerce-featured-video' ),
			/** For translation team, string added since 1.3.0  */
		...
		'big_play_border_color'      => array(
			...
			'type'      => 'yith-field',
			'desc'      => __( 'Set the border color of the big Play button', 'yith-woocommerce-featured-video' ),
			/** For translation team, string added since 1.3.0  */
			'yith-type' => 'colorpicker',
			'default'   => '#3b4249',
		...
		'import_video_section_start' => array(
			'name' => __( 'Tools', 'yith-woocommerce-featured-video' ),
			'type' => 'title',
		),
		'import_button'              => array(
			'id'        => 'ywcfav_import_button',
			'type'      => 'yith-field',
			'yith-type' => 'buttons',
			'buttons'   => array(
				array(
					'name' => __( 'Import video from Free version', 'yith-woocommerce-featured-video' ),
					'class' => 'ywcfav_import_button',
				),
			),
			'desc'      => __( 'Import all video from Free plugin version', 'yith-woocommerce-featured-video' ),
		),
		'import_video_section_end'   => array(
			'type' => 'sectionend',
		),
	),
);
