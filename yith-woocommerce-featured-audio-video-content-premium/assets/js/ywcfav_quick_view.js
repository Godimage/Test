jQuery(function ($) {
    ...
    var quick_view_image_gallery = '.yith-quick-view-content .images > a',
            ...
            $.ajax({
                ...
                success: function (response) {
                   ...
                   if( typeof  response !== 'undefined' && '' !== response ){
                       ...
                       var h =  $(document).find('.yith-quick-view-thumbs').height()+20;
                       $(document).find('.yith_featured_content').css({'margin-bottom': h+'px'});
        ...
        $(document).on('click','a.yith-wcqv-button, .yith-wcqv-button img',function(e){
            check_featured_content =false;
        });
...
$(document).on('click', '.yith-quick-view-thumbs div.yith-quick-view-single-thumb',function(e){
    var element = $(this);
    if( $('.yith-quick-view').find('.yith_featured_content').length ){
    $(document).find('.images .ywcfav_variation_content').remove();
